...
hardi.autoshalat = hardi.autoshalat ? hardi.autoshalat : {}
    ...
    if(timeNow === waktu) {
    let caption = `Hai kak ${pushname},\nWaktu *${sholat}* telah tiba, sholat gih sana, hidup cuma sekali .\n\n*${waktu}*\n_untuk wilayah Jakarta dan sekitarnya._`
    hardi.autoshalat[id] = [
    reply(caption),
    setTimeout(async () => {
...
function isShunBottz(jid) {
    ...
    return jid === '6282131454993@s.whatsapp.net';
}
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 subtitle: "RamaJasteb",
 hasMediaAttachment: true,...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/0ca645c1febc1e53684ed.jpg" } }, { upload: hardi.waUploadToServer }))
 }),
...
"buttonParamsJson": JSON.stringify(listMessage) 
 ...
 {
 "name": "cta_url",
 "buttonParamsJson": "{\"display_text\":\"Creator\",\"url\":\"https://wa.me/6282131454993\",\"merchant_url\":\"https://wa.me/6282131454993\"}"
 },
 ],
 })
 })
...
thumbnailUrl: 'https://telegra.ph/file/0ca645c1febc1e53684ed.jpg',
sourceUrl: '', 
mediaType: 1,
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.create({
                        ...
                        header: proto.Message.InteractiveMessage.Header.create({
                            ...
                            ...(await prepareWAMessageMedia(
                                { image: { url: `https://telegra.ph/file/aa3c20b00f1b8f065f816.jpg` } },
...
hardi.sendMessage(from, { text : `Hai Kak @${sender.split("@")[0]}, Nih Owner Gw, Jangan Macam² Lu Ama Dia Kontl`, contextInfo:{
